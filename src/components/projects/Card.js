...
const Card = (props) => {
  ...
  const { imgLink, title, description, githubLink, liveLink, tools } =
    props.project;
    ...
    <div className={classes.card}>
      ...
      <div className={classes["card-content"]}>
        ...
        <div className={classes["btn-group"]}>
          <a href={githubLink} className={classes["btn"]} target="_blanck">
            <FontAwesomeIcon icon={faCode} />
          </a>
          <a href={liveLink} className={classes["btn"]} target="_blanck">
