                ...
                <div className={ classes.row }>
                    <div className={ classes.edu }>
                        <div className={ classes.maintitle }>
                            <h3 className={ `${classes.title} ${them}-title` }>Udacity Nanodegree (FWD) <code>15/8/2021</code></h3>
                        </div>
                    ...
                    <div className={ classes.edu }>
                        <div className={ classes.maintitle }>
                            <h3 className={ `${classes.title} ${them}-title` }>Kalbunyan almarsus (كالبنيان المرصوص) <code>2/4/2022</code></h3>
                        </div>
                        <div className={ classes.text }>
