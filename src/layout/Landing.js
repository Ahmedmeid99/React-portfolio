    ...
    return (
        <div className={ classes.landing }>
            ...
            <div className="center">
                ...
                <p className={ classes['header-subtitle'] }>Hi my name is ahmed mohamed eid ,I am a MERN stack developer , I started learnning programming 12 months ago, I am constantly striving to increase my skills in desinging,creating web apps and learnning new technologies</p>
            </div>
        </div>
    )
}
